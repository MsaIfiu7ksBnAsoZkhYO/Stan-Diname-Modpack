...
/*
	//	sulfur Liquid	_______________________________________________________________________________________________________________________________________________________________________
var sulfur_liquid = VanillaFactory.createFluid("sulfur_liquid", Color.fromHex("FFFF4C"));
sulfur_liquid.viscosity = 10000000;
sulfur_liquid.density = 10000000;
sulfur_liquid.stillLocation = "contenttweaker:fluids/sulfur_liquid";
sulfur_liquid.flowingLocation = "contenttweaker:fluids/sulfur_liquid_flow";
sulfur_liquid.register();
*/
