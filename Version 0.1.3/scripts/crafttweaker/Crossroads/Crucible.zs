...
mods.crossroads.HeatingCrucible.addRecipe( <ore:layerSand> , <liquid:sand_liquid> * 18 , "minecraft:blocks/gravel" ); 
...
mods.crossroads.HeatingCrucible.addRecipe( <ore:lumpGravel> , <liquid:gravel_liquid> * 36 , "minecraft:blocks/gravel" ); 
mods.crossroads.HeatingCrucible.addRecipe( <ore:layerGravel> , <liquid:gravel_liquid> * 18 , "minecraft:blocks/gravel" ); 
...
mods.crossroads.HeatingCrucible.addRecipe( <ore:dustSulfur> , <liquid:sulfur> * 666 , "minecraft:blocks/gravel" ); 
...
mods.crossroads.HeatingCrucible.addRecipe( <ore:blockClay> , <liquid:clay> * 576 , "minecraft:blocks/gravel" );
mods.crossroads.HeatingCrucible.addRecipe( <ore:clay> , <liquid:clay> * 144 , "minecraft:blocks/gravel" );
mods.crossroads.HeatingCrucible.addRecipe( <ore:layerClay> , <liquid:clay> * 18 , "minecraft:blocks/gravel" );   
