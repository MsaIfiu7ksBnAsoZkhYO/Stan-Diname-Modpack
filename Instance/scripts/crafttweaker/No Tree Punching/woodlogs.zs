...
recipes.addShaped(
  ...
  [
	...
	//	Add oredicted chest recipe - Stick to see if it's still not working right.	_______________________________________________________________________________________________________________________________________________________________________
recipes.addShaped(
