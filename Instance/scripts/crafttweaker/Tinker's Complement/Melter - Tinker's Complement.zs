...
/* - Replaceing with dynamic function
...
*/
	...
	//	Override and Remove oreBlock Melter recipes.   	_______________________________________________________________________________________________________________________________________________________________________
for Liquid in MoltenMetal {
//	mods.tcomplement.Overrides.removeRecipe(MoltenMetal[Liquid]);
	//mods.tcomplement.Overrides.removeRecipe(MoltenMetal[Liquid] , Chunk[Liquid].firstItem);
	//mods.tcomplement.Overrides.removeRecipe(MoltenMetal[Liquid] , RockyChunk[Liquid].firstItem);
}

for item in Chunk {
//	mods.tcomplement.Overrides.addRecipe(MoltenMetal[item] * 144 , Chunk[item].firstItem , MeltingTemp[item]);
}