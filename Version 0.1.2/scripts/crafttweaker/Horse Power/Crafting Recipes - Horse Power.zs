...
RecipeBuilder.get("basic")
  ...
  .create();
	...
	//	Horse Grindstone from Hand Grindstone	_______________________________________________________________________________________________________________________________________________________________________
RecipeBuilder.get("basic")
  .setShaped([
    [<minecraft:lead>, <horsepower:hand_grindstone>, <minecraft:lead>]])
  .addOutput( <horsepower:grindstone> )
  .create();