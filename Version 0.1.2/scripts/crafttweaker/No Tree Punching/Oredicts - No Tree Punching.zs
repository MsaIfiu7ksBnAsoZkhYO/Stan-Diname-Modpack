...
<ore:rockSandstone>.add(<notreepunching:rock/red_sandstone>);
	...
	//	Add some more kindling.	_______________________________________________________________________________________________________________________________________________________________________
<ore:kindling>.add(<biomesoplenty:plant_0:12>);