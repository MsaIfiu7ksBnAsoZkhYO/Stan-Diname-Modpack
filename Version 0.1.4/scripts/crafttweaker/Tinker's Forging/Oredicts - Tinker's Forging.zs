...
//==============================================================
//	Oredict entries the anvil wants for these materials.
//==============================================================
...
<ore:hammer>.add(<tinkerscompendium:mallet:*>);
	...
	//	Project Red	_______________________________________________________________________________________________________________________________________________________________________
<ore:ingotElectrotine>.add(<projectred-core:resource_item:104>);
<ore:ingotRedalloy>.add(<projectred-core:resource_item:103>);

	//	Nuclearcraft
<ore:ingotHslasteel>.add(<nuclearcraft:alloy:15>);

	//	Techguns
<ore:ingotObsidiansteel>.add(<techguns:itemshared:84>);
...
<ore:ingotGaiaspirit>.add(<botania:manaresource:14>);
