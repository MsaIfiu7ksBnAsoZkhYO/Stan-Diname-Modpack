...
for Metal in CastMetals{   
	...
	mods.tconstruct.Casting.addTableRecipe(<tconstruct:cast>.withTag({PartType:"tinkerscompendium:td_armor_plate"}), <tinkerscompendium:td_armor_plate>.withTag({Material:"wood"}), Metal, 144, true, 200);
	mods.tconstruct.Casting.addTableRecipe(<tconstruct:cast>.withTag({PartType:"tinkerscompendium:td_chainmail"}), <tinkerscompendium:td_chainmail>.withTag({Material:"wood"}), Metal, 144, true, 200);
	mods.tconstruct.Casting.addTableRecipe(<tconstruct:cast>.withTag({PartType:"tinkerscompendium:td_rivets"}), <tinkerscompendium:td_rivets>.withTag({Material:"wood"}), Metal, 144, true, 200);
	mods.tconstruct.Casting.addTableRecipe(<tconstruct:cast>.withTag({PartType:"tinkerscompendium:td_filigree"}), <tinkerscompendium:td_filigree>.withTag({Material:"wood"}), Metal, 144, true, 200);
}
...
for Item , Fluid in ClayBrickItems {
	...
	if (debug) {print("Fluid: "~Fluid.displayName);}
	mods.tconstruct.Casting.addTableRecipe(Item , <contenttweaker:brick_mold> , Fluid , 144 , true , 100);
...
/* - Removing due to revied Processing method
